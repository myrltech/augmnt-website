...
const awardArray = [
  {
    imgPath: "imgs-agency/mobile/home/best-winter-icon.svg",
    imgClass: "mobile-best-winter-icon",
    imgName: "best winter",
  },
  {
    imgPath: "imgs-agency/mobile/home/trustpilot.svg",
    imgClass: "mobile-trustpilot-img",
    imgName: "trustpilot",
  },
  {
    imgPath: "imgs-agency/mobile/home/capterra.svg",
    imgClass: "mobile-capterra-img",
    imgName: "capterra",
  },
  {
    imgPath: "imgs-agency/mobile/home/gartner.svg",
...
const techAgenciesArray = [
  {
    title: "Verified",
    icon: "imgs-agency/mobile/icons/green-shield-icon.png",
    iconClass: "mobile-green-shield-icon",
    para: "Lorem ipsum dolor sit amet, consectetur adipiscing elit,",
  },
  {
    title: "Vetted",
    icon: "imgs-agency/mobile/icons/orange-arrow-icon.png",
    iconClass: "mobile-orange-arrow-icon",
    para: "Lorem ipsum dolor sit amet, consectetur adipiscing elit,",
  },
  {
    title: "Trusted",
    icon: "imgs-agency/mobile/icons/red-star-icon.png",
  ...
  return (
    <>
      <h2 className="text-center ">
        <img
          src="/imgs-agency/mobile/home/home-title-text.svg"
