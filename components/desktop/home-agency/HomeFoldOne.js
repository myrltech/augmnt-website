          ...
          <Fragment key={key}>
            <div className="col-6 p-0">
              <div className="d-flex align-items-start home-new-count-text-card">
                <img
                  src="/imgs-agency/desktop/home-new/home-augmnt-logo.png"
                  alt="augmnt"
  ...
  return (
    <div className="home-new-fold-one-section">
      ...
      <div className="text-right home-fold-one-img-section d-none d-md-block">
        <img
          src={"/imgs-agency/desktop/home-new/home-fold-one-bg-img.png"}
          alt="fold one"
          className="home-new-fold-one"
        />
        <div className="home-fold-one-img-section-text-img">
          <img
            src={"/imgs-agency/desktop/home-new/home-fold-one-text-block-img.png"}
      ...
      <div className="mobile-text-left d-block d-md-none">
        <img
          src={"/imgs-agency/mobile/home-new/home-mobile-fold-one.png"}
          alt="fold one"
          className="home-new-fold-one"
        />
      </div>
