...
const upArrow = "/imgs-agency/desktop/listings/upword-arrow.svg";
const downArrow = "/imgs-agency/desktop/listings/down-arrow.svg";
const rightSpringArrow = "/imgs-agency/desktop/listings/right-spring-arrow-icon.svg";
const rightArrow = "/imgs-agency/desktop/listings/right-arrow-icon.svg";
const personIcon = "/imgs-agency/desktop/listings/running-person.svg";
      ...
      <div className="community-for-section d-flex">
        ...
        <div className="d-flex align-items-center relative pl-72">
          ...
          <div className="banner-group-img">
            <img
              src={"/imgs-agency/desktop/listings/banner-img.svg"}
